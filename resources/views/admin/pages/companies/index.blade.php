        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-4 font-13">
                    Manage companies.
                    <a href="{{route('admin.company.add.new')}}" class="btn btn-outline-primary btn-round waves-effect waves-light">Add new</a>
                </p>

                <div class="table-responsive">
                    <table id="companies-datatable" class="table mb-0 table-centered">
                        <thead>
                        <tr>
                            <th>Name</th>
                            <th>Address</th>
            ...
            columnDefs: [
    
                {
                    ...
                    render: function(data, type, row, meta){
                        let a = `<a class="badge badge-pill badge-outline-primary badge-medium" href="/companies/edit/${row.uuid}">View</a>&nbsp;&nbsp;`;
